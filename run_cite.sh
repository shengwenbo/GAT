...
python execute_citeseer_sep.py train 4,1 6,1 0.6 0.6 36 ./out_cite/$i ./log_cite/$i
python execute_citeseer_sep.py train 6,1 4,1 0.6 0.6 36 ./out_cite/$i ./log_cite/$i
python execute_citeseer_sep.py train 4,4 6,1 0.6 0.6 36 ./out_cite/$i ./log_cite/$i
python execute_citeseer_sep.py train 6,6 4,1 0.6 0.6 36 ./out_cite/$i ./log_cite/$i
python execute_citeseer_sep.py train 6,6 6,1 0.6 0.6 36 ./out_cite/$i ./log_cite/$i
...
python execute_citeseer_sep.py train 4,1 6,1 0.6 0.6 12 ./out_cite/$i ./log_cite/$i
python execute_citeseer_sep.py train 6,1 4,1 0.6 0.6 12 ./out_cite/$i ./log_cite/$i
python execute_citeseer_sep.py train 4,4 6,1 0.6 0.6 12 ./out_cite/$i ./log_cite/$i
python execute_citeseer_sep.py train 6,6 4,1 0.6 0.6 12 ./out_cite/$i ./log_cite/$i
python execute_citeseer_sep.py train 6,6 6,1 0.6 0.6 12 ./out_cite/$i ./log_cite/$i
